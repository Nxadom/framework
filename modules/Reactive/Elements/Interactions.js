...
class Interactions {
  ...
  toggleSortable() {
    console.log(
      "🔄 Interactions.toggleSortable called - delegated to Sortable class"
    );
  ...
  toggleDraggable() {
    console.log(
      "🔄 Interactions.toggleDraggable called - delegated to Draggable class"
    );
  ...
  toggleResizable() {
    console.log(
      "🔄 Interactions.toggleResizable called - delegated to Resizable class"
    );
