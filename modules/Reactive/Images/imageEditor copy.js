class imageEditor {
  ...
  /**
   * Show professional confirmation modal for reset
   */
  showResetConfirmationModal() {
    // Remove existing modal if any
    const existingModal = document.getElementById("nexa-reset-confirm");
    if (existingModal) {
          ...
          <div class="nx-modal-content">
            <div class="nx-modal-header">
              <h5 class="nx-modal-title">
                <span class="material-symbols-outlined" style="margin-right: 0.5rem; color: #dc2626;">warning</span>
                Reset All Changes
              </h5>
              <button type="button" class="nx-modal-close" onclick="closeModal('${modalId}')">
                <span class="material-symbols-outlined">close</span>
            ...
            <div class="nx-modal-footer" style="display: flex; justify-content: center; gap: 1rem;">
              <button class="btn btn-outline-secondary" onclick="closeModal('${modalId}')">
                <span class="material-symbols-outlined" style="font-size: 16px; margin-right: 0.25rem;">close</span>
                Cancel
              </button>
      ...
      try {
        ...
        canvas.toBlob((blob) => {
          if (blob) {
            ...
            // Close modal
            const modal = document.getElementById("nexa-image-editor");
            if (modal) {
              modal.remove();
            }
          } else {
